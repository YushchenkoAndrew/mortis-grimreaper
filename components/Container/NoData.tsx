    ...
    <div className={`mx-auto ${props.className || ''}`}>
      ...
      >
        <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
          <div className="p-3 mx-auto text-blue-500 dark:text-blue-400 bg-blue-100 dark:bg-gray-800 rounded-full">
            <FontAwesomeIcon
              className="pt-1 px-0.5 w-6 h-5"
              icon={faMagnifyingGlass}
            />
          </div>
          <h1 className="mt-3 text-lg font-medium text-gray-800 dark:text-gray-300">
