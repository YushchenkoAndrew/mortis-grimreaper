...
export default function TaskFormCreatePage(props: TaskFormPageCreateProps) {
  ...
  const onSubmit = useCallback(() => {
    ErrorService.envelop(async () => {
      ...
      if (form.description) {
        const additional = new AdminTaskEntity({ description: form.description, id: res.id, stage_id: form.stage_id }); // prettier-ignore
        await dispatch(AdminTaskEntity.self.save.thunk(additional)).unwrap(); // prettier-ignore
      }
